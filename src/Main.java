...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("To check the game you need to enter commands:" +
                " 'exit' - to exit" +
                " 'replay' - to restart the game" +
                "  'castling0' or 'castling7' - for castling along the corresponding line" +
                "   'move 1 1 2 3' - to move a figure from position 1 1 to 2 3 " +
                "(the field is a two-dimensional array from 0 to 7)" +
                "  Check whether the pieces can walk through each other," +
                " whether they eat each other correctly, is it possible to  put a check and castling? ");
        System.out.println();
        board.printBoard();
        while (true) {
                ...
                if (s.equals("castling0")) {
                    ...
                    try {
                        ...
                        if (board.moveToPosition(line, column, toLine, toColumn)) {
                            System.out.println("Successfully re moved");
                            board.printBoard();
                        } else System.out.println("the  move failed");
                    } catch (Exception e) {
